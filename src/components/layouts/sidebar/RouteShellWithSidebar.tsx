...
const RouteShellWithSidebar: React.FCC<{
  ...
  return (
    <div className={'flex h-full flex-1 overflow-hidden'}>
      ...
      <div className={'relative mx-auto h-screen w-full overflow-y-auto'} data-name={"body-scroll-view"}>
        <AppHeaderNoMenu>
        ...
        <div className={'p-3 bg-slate-50 min-h-screen dark:bg-black-400'}>{children}</div>
      </div>
    </div>
  );
};
