  ...
  return (
    <SlideUpTransition>
      <div className={'flex flex-col space-y-12'}>
        ...
        <div
          className={
            'flex flex-col items-start items-stretch space-y-6 lg:space-y-0' +
        ...
        >
          {STRIPE_PRODUCTS.map((product) => {
            ...
            const isFreePlan = plan.price.toLowerCase() === 'free';

            return (
              <PricingItem
                selectable={isFreePlan}
  ...
  return (
    ...
    >
      ...
      <div className={'bottom-0 left-0 w-full p-0'}>
        <If
          condition={
            props.plan.stripePriceId && props.selectable && props.CheckoutButton
          }
          fallback={
        ...
        >
          {(CheckoutButton) => (
            <CheckoutButton
              ...
              className={
                props.selectable ? '' : 'pointer-events-none opacity-0'
              }
            />
          )}
        </If>
