...
export function getClassNameBuilder() {
  return cva(
    [
    ...
    ],
    {
      ...
      compoundVariants: [
        ...
        },
        {
          color: 'primary',
          variant: 'outline',
          className: `border-2 border-primary-400 dark:focus:ring-primary-500/70 bg-transparent text-primary-700 rounded-md`,
        },
        {
          color: 'secondary',
          variant: 'outline',
          className: `border border-gray-300 dark:focus:ring-gray-100/70 bg-transparent text-gray-700 rounded-md`,
        },
        {
          color: 'danger',
          variant: 'outline',
